...
<html>
	...
	<body class="site">
		...
		<div class="lang-container">
			<a href="#" class="link lang-icon" title="Espanhol">ES</a>
			<a href="#" class="link lang-icon" title="Português">PT</a>
			<a href="#" class="link lang-icon" title="Inglês">EN</a>
		</div>
					...
					<div class="pagina-content">
						...
						<div class="logo-wrap">
							...
							<div class="social-links">
								...
								<!-- facebook -->
								<a href="https://www.facebook.com/obec.rs/" class="link social-icon face-icon" target="_blank" title="Facebook"></a>

								<!-- instagram -->
								<a href="https://www.instagram.com/obec.ufrgs/" class="link social-icon insta-icon" target="_blank" title="Instagram"></a>

								<!-- twitter -->
								<a href="https://twitter.com/OBEC_RS" class="link social-icon twitter-icon" target="_blank" title="Twitter"></a>

								<!-- youtube -->
								<a href="https://www.youtube.com/channel/UCDq6cCG5p9thYTGgZEuSeGA" class="link social-icon youtube-icon" target="_blank" title="Youtube"></a>
						...
						<div class="menu menu-inicio menu-capa">
							<ul class="menu-opt"> 
								...
								<!-- Sobre -->
								<li><span href="sobre" class="link">Sobre</span></li>
								
								<!-- ícone -->
								<li><div class="menu-icon"></div></li>
								
								<!-- Projetos -->
								<li><span href="projetos" class="link">Projetos</span></li>

								<!-- ícone -->
								<li><div class="menu-icon"></div></li>

								<!-- Acervo -->
								<li><span href="acervo" class="link">Acervo</span></li>
						...
						<div class="lateral lateral-center">
							<div class="pagina-content-lateral text-center">
								...
								<div class="content-lateral-center">
									...
									<!-- /* home */ -->
									<div class="menu">
										<span href="inicio" class="link logo-icon"></span>
									</div>
								...
								<div class="menu-inicio">
									...
									<ul class="menu menu-opt"> 
										...
										<!-- Sobre -->
										<li><span href="sobre" class="link active">Sobre</span></li>
			...
			<div id="pagina-projetos">
				<div class="pagina-wrap projetos-wrap">
					...
					<div class="container-laterais">
						...
						<!-- *\/\* navegação horizontal */\/* -->
						<div class="nav-x nav-x-left open-projetos">
						...
						<div class="nav-x nav-x-right open-projetos">
							...
							<div class="pagina-content-lateral text-center">
								...
								<div class="menu-inicio">
									...
									<ul class="menu menu-opt"> 
										...
										<!-- Projetos -->
										<li><span href="projetos" class="link active">Projetos</span></li>
							...
							<div class="pagina-content-lateral text-center">
								...
								<div class="menu-inicio">
									...
									<ul class="menu menu-opt"> 
										...
										<!-- Acervo -->
										<li><span href="acervo" class="link active">Acervo</span></li>
							...
							<div class="pagina-content-lateral text-center">
								...
								<div class="menu-inicio">
									...
									<ul class="menu menu-opt"> 
										...
										<!-- Agenda -->
										<li><span href="agenda" class="link active">Agenda</span></li>
